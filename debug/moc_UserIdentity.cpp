...
#include "../src/core/UserIdentity.h"
...
void UserIdentity::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UserIdentity *_t = static_cast<UserIdentity *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (UserIdentity::*_t)(const QString & );
        ...
        {
            typedef void (UserIdentity::*_t)(Protocol::Connection * );
...
const QMetaObject UserIdentity::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UserIdentity.data,
      qt_meta_data_UserIdentity,  qt_static_metacall, nullptr, nullptr}
};
