...
#include "../src/tor/GetConfCommand.h"
...
void Tor::GetConfCommand::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        GetConfCommand *_t = static_cast<GetConfCommand *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject Tor::GetConfCommand::staticMetaObject = {
    { &TorControlCommand::staticMetaObject, qt_meta_stringdata_Tor__GetConfCommand.data,
      qt_meta_data_Tor__GetConfCommand,  qt_static_metacall, nullptr, nullptr}
};
