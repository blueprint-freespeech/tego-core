#############################################################################
# Makefile for building: ricochet-refresh
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  ricochet.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile ricochet.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ricochet-refresh1.1.4
DISTDIR = /home/arufu/code/cpp/eResearch/ricochet-refresh/.tmp/ricochet-refresh1.1.4
SUBTARGETS    =  \
		release \
		debug
...
Makefile: ricochet.pro .qmake.cache /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
