...
#include "../src/tor/TorControlSocket.h"
...
void Tor::TorControlSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TorControlSocket *_t = static_cast<TorControlSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TorControlSocket::*_t)(const QString & );
...
const QMetaObject Tor::TorControlSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_Tor__TorControlSocket.data,
      qt_meta_data_Tor__TorControlSocket,  qt_static_metacall, nullptr, nullptr}
};
