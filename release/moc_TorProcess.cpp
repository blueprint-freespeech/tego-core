...
void Tor::TorProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TorProcess *_t = static_cast<TorProcess *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TorProcess::*_t)(int );
        ...
        {
            typedef void (TorProcess::*_t)(const QString & );
...
const QMetaObject Tor::TorProcess::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Tor__TorProcess.data,
      qt_meta_data_Tor__TorProcess,  qt_static_metacall, nullptr, nullptr}
};
